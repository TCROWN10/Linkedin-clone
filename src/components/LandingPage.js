...
import image1 from './assets/_DSC0017.JPG';
import image2 from './assets/Jolah.png';
import image3 from './assets/_DSC0039.JPG';
import image4 from './assets/_DSC0042.JPG';
import image5 from './assets/_DSC0067.JPG';
import image6 from './assets/_DSC0098.JPG';
import image7 from './assets/_DSC0323.JPG';
import image8 from './assets/BBS_6837.JPG';
import profileImage1 from './assets/Tobi.png';
import profileImage2 from './assets/Ayodeji Awosika.png';
    ...
    return (
      <div className="App">
        ...
        <div className='content-container flex flex-row gap-x-8 mt-8 mx-auto max-w-6xl'>
          ...
          <div>
            <ProfileCard  showImage={true} showBackground={true} showProfile={true} showBio={true} />
  
  
            <ProfileCard showImage={false} showBackground={false} showProfile={false} showBio={false} />
          </div>
